...
//		//		/// </summary>
//		public static IHttpClientBuilder AddGoreRemotingGrpcClient<T>(this IServiceCollection services) where T : class
//		{
//			//throw new Exception();
//			//=> services.AddGrpcClient<T>().ConfigureCodeFirstGrpcClient<T>();
//			return services.AddGrpcClient<T>().ConfigureGoreRemotingGrpcClient<T>();





//			//.AddGoreRemotingClient<>(lol =>
//			// {
//			//	 lol.AddService<IService1>();
//			//	 lol.AddService<IService2>();
...
//		//		/// </summary>
//		//public static IHttpClientBuilder ConfigureGoreRemotingGrpcClient<T>(this IHttpClientBuilder clientBuilder) where T : class
